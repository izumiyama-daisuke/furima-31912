  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できないとき' do
      ...
      it 'first_nameが空では登録できない' do
        @user.first_name = nil
        @user.valid?
        expect(@user.errors.full_messages).to include('苗字を全角（漢字・ひらがな・カタカナ）を使用してください')
      end
      it 'last_nameが空では登録できない' do
        @user.last_name = nil
        @user.valid?
        expect(@user.errors.full_messages).to include('名前を全角（漢字・ひらがな・カタカナ）を使用してください')
      end
      it 'first_kanaが空では登録できない' do
        @user.first_kana = nil
        @user.valid?
        expect(@user.errors.full_messages).to include('苗字に全角（カタカナ）を使用してください')
      end
      it 'last_kanaが空では登録できない' do
        @user.last_kana = nil
        @user.valid?
        expect(@user.errors.full_messages).to include('名前に全角（カタカナ）を使用してください')
      end
